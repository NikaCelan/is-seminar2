...
##distribution##
#Za V1#
train_twos = train[train$Class == 2,]
train_ones = train[train$Class == 1,]

plot(train_ones$V1, xlab="", ylab = "", main="", xaxt = "n", col='red')
points(train_twos$V1, xlab="", ylab = "", main="", xaxt = "n", col='blue')
...
***decision tree with subset of 17 important features***
...
feature_top_5 = feature_import_sorted[1:5,1]
feature_top_5[6] = "Class"

set.seed(100)
library(randomForest)
train.rf <- randomForest(Class ~ ., data = train[feature_top_5], trControl=trainControl(method='repeatedcv', number=10, repeats=5, 
