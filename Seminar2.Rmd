...
bestKNN <- CoreModel(Class ~ ., data = train, model="knn", kInNN = bestK)
...
qplot(1:20, overallScores, xlab = "k", ylab = "Performance(acc)", geom = c("point","line"))
